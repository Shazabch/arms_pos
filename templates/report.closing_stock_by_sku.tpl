...
<span class="ml-3 text-primary">{$p_branch.description}<br>{$title}</span>					
...
<div class="form-inline">
	<input class="form-control" type="text" name="date" value="{$form.date}" id="added1" readonly="1" size="23"> 
...
<div class="card mx-3">
	<div class="card-body">
		<div class="table-responsive">
			<table class="report_table small_printing table mb-0 text-md-nowrap  table-hover" {if $no_header_footer}border="1"{/if} width=100%>
