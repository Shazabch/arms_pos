...
<tr>
	...
	<td rowspan=2 align=right>
	    <table class="xlarge">
		<tr><td colspan=2>
		<div style="padding:4px;" align="center"><b>
...
{/if}
*}
    <th align=right colspan={if !$hide_RSP}7{else}6{/if} >Total</th>
