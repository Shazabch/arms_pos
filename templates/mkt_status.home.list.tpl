...
<tr>
	<td>
		{if $list[i].status==0}
		<a href="?a=open&id={$list[i].id}&branch_id={$list[i].branch_id|default:$sessioninfo.branch_id}"><img src=/ui/ed.png border=0></a>
		{else}
		<a href="?a=view&id={$list[i].id}&branch_id={$list[i].branch_id|default:$sessioninfo.branch_id}"><img src=/ui/view.png border=0></a>
		{/if}
	</td>
