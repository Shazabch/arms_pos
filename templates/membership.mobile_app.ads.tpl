...
<form name="f_screen" onSubmit="return false;">
	<table>
		{* Select Screen *}
		<tr>
			<td><b>Select Screen: </b></td>
			<td>
				<select name="screen_name" onChange="ADS_SETUP.screen_changed();">
...
<div id="div_banner_list" class="stdframe" style="background-color: #fff;">
</div>

<script>ADS_SETUP.initialise();</script>
