...
<form name="f_a" method="post" onSubmit="return false;">
	...
	<span>
		<b>Show By</b>
		<select name="data_type" onchange="BRAND_VENDOR_SALES_BY_PRICE_TYPE_AND_DISCOUNT.onchange_data_type(this);">
			<option value="">-- Please Select --</option>
	...
	<p>
		<input class="btn btn-primary" type="button" value='Show Report' onClick="BRAND_VENDOR_SALES_BY_PRICE_TYPE_AND_DISCOUNT.submit_form();" /> &nbsp;&nbsp;

		{if $sessioninfo.privilege.EXPORT_EXCEL}
			<button class="btn btn-primary" name="output_excel" onClick="BRAND_VENDOR_SALES_BY_PRICE_TYPE_AND_DISCOUNT.submit_form('excel');"><img src="/ui/icons/page_excel.png" align="absmiddle"> Export</button>
		{/if}
	</p>
</form>
</div>
