	...
	<div class="card mx-3">
		<div class="card-body">
			<div class="noprint stdframe">
				...
				<table class="form_body">
					<tr>
						{if $BRANCH_CODE eq "HQ"}
							<th align="left" class="form-label mt-2">Branch :</th>
							<td>
						...
						{/if}
						<th align="left" class="form-label mt-2">Date From :</th>
						<td>
						...
						<th class="form-label mt-2">Date To :</th>
						<td>
						<div class="form-inline">
					...
					<tr >
						<th align="left" class="form-label mt-2">SKU Type :</th>
						<td>
						...
						<th align="left" class="form-label mt-2">Sort by :</th>
						<td>
							<div class="form-inline">
				...
				<table class="form_body">
					<tr>
						<th class="form-label mt-2">Show finalized POS only</th>
				...
				{if $sessioninfo.privilege.EXPORT_EXCEL eq '1'}
					<button class="btn btn-info" onClick="MPRICE_SALES_REPORT.submit_form('excel');"><img src="/ui/icons/page_excel.png" align="absmiddle"> Export</button>
				{/if}
