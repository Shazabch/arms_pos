{*
12/21/2011 10:22:43 AM Andy
- New DO printing templates for reswar.

12/22/2011 10:48:49 AM Andy
- Modified to same as wshqkb format.

8/19/2013 9:31 AM Fithri
- assign document no as filename when print

3/23/2015 4:26 PM Andy
- Enhance custom template to compatible with GST.

5/13/2015 10:27 AM Andy
...
<tr bgcolor=#cccccc>
	...
	<th width=80>Total Amount {if $form.is_under_gst}Included GST{/if}<br>(RM)</th>
</tr>
