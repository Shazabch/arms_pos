		...
		<form method="post" class="form" name="f_a">
			...
			<div class="col">
				...
				<div class="form-inline">
					<input size="20" type="text" name="date_from" value="{$smarty.request.date_from|default:$form.date_from}" id="date_from" class="form-control">
			...
			<div class="col">
				...
				<div class="form-inline">
					<input size="20" type="text" name="date_to" value="{$smarty.request.date_to|default:$form.date_to}" id="date_to" class="form-control">
			...
			<p>
				<div class="row">
					<div class="col">
						<b class="form-label ">Sales Amount by Month [<a href="javascript:void(alert('This filter will not affect the KPI Performance results'));">?</a>]</b>
				<select class="form-control" name="amt_filter_type">
				...
				<div class="col">
					<b class="form-label">Than</b>
				<input type="text" name="amt_filter" value="{$smarty.request.amt_filter}" onchange="mf(this);" size="15" class="r form-control" />
				</div>
			
			
				<div class="col">
					<b class="form-label">Sales Amount Sort By</b>
...
{if $kpi_table}
	...
	<div class="breadcrumb-header justify-content-between">
		<div class="my-auto">
			<div class="d-flex">
				<h4 class="content-title mb-0 my-auto ml-4 text-primary">Sales Agent KPI Performance</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0"></span>
			</div>
		</div>
	</div>
	<div class="card mx-3">
