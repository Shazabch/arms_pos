...
<tr id="sku_search_txt">
	<th align=left class="form-label">Search SKU</th>
	<td>
		...
		<div id=scan style="display:none"><input class="form-control" id=sku_scan name=sku_scan size=50 style="font-size:14px;width:500px;" onKeyPress="checkkey(event)"></div>
