...
<form name="f_a" onSubmit="return false;">
	...
	<input id="inp_reload_kpi" type="button" value="Search" onClick="SALES_AGENT_KPI_MODULE.reload_kpi_list();" />
</form>
...
<div class="ndiv" id="div_sa_kpi_table" style="position:absolute;width:400px;height:200px;display:none;z-index:10000;">
<div class="blur"><div class="shadow"><div class="content">

<div class="small" style="position:absolute; right:10; text-align:right;"><a onclick="SALES_AGENT_KPI_MODULE.sa_kpi_table_fade();" accesskey="C"><img src="ui/closewin.png" border="0" align="absmiddle" style="pointer:cursor;"></a><br><u>C</u>lose (Alt+C)</div>
...
<form method="post" name="f_b" onSubmit="return SALES_AGENT_KPI_MODULE.validate();">
	...
	<table>
		...
		<tr>
			...
			<td><input onBlur="uc(this)" name="description" size="30" maxlength="40"> <img src="ui/rq.gif" align="absbottom" title="Required Field"></td>
		</tr>
		<tr>
			<td><b>Additional Description</b></td>
			<td><textarea name="additional_description" rows="5" cols="30"></textarea></td>
		</tr>
		<tr>
			<td><b>Max Scores</b></td>
			<td><input onBlur="mf(this)" name="scores" size="5" maxlength="5"> <img src="ui/rq.gif" align="absbottom" title="Required Field"></td>
		</tr>
	</table>
	<!-- bottom -->
