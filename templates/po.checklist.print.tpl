...
- Added Branch Code and Branch Description.
*}
...
<tr>
	<td valign=top>
		<h2>{$billto.code} - {$billto.description}{if $billto.company_no} ({$billto.company_no}){/if}</h2><br>
...
<tr height=15 class="rw{cycle name=crow values=",2"}">
	...
	<td rowspan=2 nowrap>
		{if $item.artno}{$item.artno|default:"&nbsp;"}{else}{$item.mcode|default:"&nbsp;"}{/if}
