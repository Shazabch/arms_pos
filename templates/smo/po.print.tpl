...
10/17/2013 11:58 AM Justin
- Enhanced to take off Tax and ATP code.

10/28/2013 10:51 AM Justin
- Bug fixed on row of total amount does not fit to the column.

11/19/2013 11:55 AM Andy
- Enhanced to pickup some of the CSS elements from print.css.
...
5/14/2015 11:48 AM Justin
- Enhanced to remove some spaces between items table and signature table to avoid printing into 2 pages.

12/28/2015 10:10 AM Qiu Ying
...
{/if}
		...
		<tr><td nowrap>PO Date</td><td nowrap>{$form.po_date|date_format:$config.dat_format}
...
{assign var=famt_colspan value=9}
{if $form.is_under_gst}
...
<!-- total -->
<tr height=30>
    <td colspan="3" rowspan=6 style="background:none" valign=top>
    <h4>Remark</h4>
	{$form.remark|nl2br}
	</td>
	<td class="ft" nowrap>
...
<tr height=20 class="ft topline">
	<td colspan=8 align=right><b>Miscellanous Cost</b></td>
...
{if $form.rdiscount}
<tr height=20 class="ft topline">
	<td colspan=8 align=right><b>Discount from Remark</b></td>
...
<tr height=20 class="ft topline">
	<td colspan=8 align=right><b>Transport Charges</b></td>
...
<tr height=30>
	...
	<td class="ft" align=right><b>T.Amount</b></td>
...
<tr class="ft topline">
	<td align=right><b>T.Selling</b></td>
...
<tr height=20 class="ft topline">
	<td colspan=8 align=right><b>Discount from Remark#2</b></td>
...
<tr height=20 class="ft topline">
	<td colspan=8 align=right><b>Deduct Cost from Remark#2</b></td>
...
<!-- final final amount -->
<tr class="ft2 topline">
	<td colspan=8 align=right><b>Actual PO Amount</b></td>
	<td nowrap align=right>
...
<tr class="ft2 topline">
	<td colspan=8 align=right><b>Total Selling</b></td>
	<td align=right>{$form.total_selling_amt|number_format:2}</td>
	<td align=right>
...
<!-- final final amount -->
<tr class="ft2 topline">
	<td colspan=8 align=right><b>Supplier PO Amount</b></td>
	<td nowrap align=right>
