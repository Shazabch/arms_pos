...
7/15/2011 3:06:40 PM Andy
- Add include 'header.print.tpl' for all printing templates, added support charset utf8.

8/9/2011 4:27:39 PM Andy
...
{foreach from=$do_items key=item_index item=r}
	...
	<tr class="no_border_bottom">
		...
		<td align=center>{if $r.mcode <> ''}{$r.mcode}{else}{$r.sku_item_code|default:'&nbsp;'}{/if}</td>
		...
		{if !$page_item_info.$item_index.not_item}
			...
			{* assign var=amt_ctn value=$cost_pricee*$r.ctn}
