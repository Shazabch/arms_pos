{*
3/14/2017 9.18AM ChongMeng

4/4/2014 4.36PM ChongMeng
- Add "Must Printed Invoice" checkbox

06/30/2020 10:41 AM Sheila
- Updated button css.

10/15/2020 5:15 PM William
		...
		<div class="noprint stdframe">
			...
			<input type="hidden" name="cat_id" value="{$smarty.request.cat_id}" />
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="form-label form-inline mt-5">
				...
				<!-- 	<b>DO Status</b>
					...
					<div class="col-md-3">
						<div class="form-label form-inline mt-5">
							<input type="checkbox" name="printed_inv" value="1" {if $smarty.request.printed_inv}checked {/if} />
					<b>&nbsp;Must Printed Invoice</b>
						</div>
					</div>
	...
	<div class="card-body">
		<div class="table-responsive">
			<table class="sortable tb table mb-0 text-md-nowrap  table-hover" >
				...
				{include file='report.cash_credit_sales.table.tpl'}
				
				<tr class="sortbottom fs-08">
