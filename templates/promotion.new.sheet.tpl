...
<tr class="normal" bgcolor="{#TB_ROWHEADER#}" id="add_sku_row" style="{if !$allow_edit}display:none; {/if}">
	...
	<td colspan="25" nowrap>
	<b>Search Category</b>
	<input readonly id=category_id name=category_id size=3 value="{$smarty.request.category_id}">
	<input type=hidden id=category_tree name=category_tree value="{$smarty.request.category_tree}">
	<input id=autocomplete_category name=category value="{$smarty.request.category|default:'Enter keyword to search'}" onfocus=this.select() size=50>
	<span id="brand_select">
	<b>Brand</b>
	<input id=autocomplete_brand name=brand value="" onfocus=this.select() size=50>
	...
	<b>Vendor</b>
	<input id=autocomplete_vendor name=vendor value="" onfocus=this.select() size=50>
	...
	*}
	...
	<input type=button value="List" onclick='list_sku();'>
