...
7/15/2011 1:38:53 PM Andy
- Add include 'header.print.tpl' for all printing templates, added support charset utf8.

8/10/2011 3:05:43 PM Andy
...
<tr class="no_border_bottom {if $smarty.section.i.iteration eq $PAGE_SIZE and !$is_lastpage}td_btm_got_line{/if}">
	...
	<td align="center" nowrap>{$do_items[i].mcode|default:'&nbsp;'}</td>
	...
	{if !$page_item_info[i].not_item}
		...
		{*
		{if !$config.do_print_hide_cost}
			<td align="right">{$do_items[i].cost_price/$do_items[i].uom_fraction|number_format:2}</td>
		{/if}
		*}
