...
<div class="breadcrumb-header justify-content-between">
	<div class="my-auto">
		<div class="d-flex">
			<h4 class="content-title mb-0 my-auto ml-4 text-primary">GRN Summary</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0"></span>
		</div>
	</div>
</div>
		...
		<form name=f1 class="noprint" action="{$smarty.server.PHP_SELF}" method="get" >
			...
			{/if}
				...
				<div class="col-md-4">
					...
					<select class="form-control" name="department_id" onchange="dept_changed(this);">
					<option value="">-- All --</option>
			...
			<b class="form-label">Document Type</b>
			...
			<div class="row">
				<div class="col">
					<input class="btn btn-primary mt-2" type="button" onClick="submit_form();" value="Refresh" />
			<input class="btn btn-primary mt-2" type="button" value="Print" onClick="window.print();" />
			{if $sessioninfo.privilege.EXPORT_EXCEL}
				<button class="btn btn-info mt-2" onClick="submit_form('excel');"><img src="/ui/icons/page_excel.png" align="absmiddle"> Export</button>
			{/if}
			{/if}
				</div>
			</div>
