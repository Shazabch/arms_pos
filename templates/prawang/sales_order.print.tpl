...
12/28/2015 9:18 AM Qiu Ying
- SKU Additional Description should show in document printing

4/3/2017 16:03 Qiu Ying
- Enhanced to add mcode column

4/26/2017 8:22 AM Khausalya
...
<tr bgcolor=#cccccc>
	...
	<th rowspan=2 width=40>Total<br>Amount {if $form.is_under_gst}Included GST{/if}</th>
</tr>
...
{if $is_lastpage}
	...
	<!-- Sheet Discount -->
	<tr>
	    <th align="right" colspan="7" >Discount</th>
