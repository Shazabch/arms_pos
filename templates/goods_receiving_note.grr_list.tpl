...
<div class="card mx-3">
	<div class="card-body">
		<div class="table-responsive">
			...
			style="{if !$config.use_grn_future}{/if} padding:2;" cellpadding="4" cellspacing="1" border="0">
				...
				<tbody class="fs-08" {if count($grr) > 25}style="height:600px;overflow-y:auto;overflow-x:hidden;"{/if}>
...
<div class="alert alert-primary rounded mx-3">
	<img src="ui/bananaman.gif" align="absmiddle"> Horray! there are no GRR at the moment.
</div>
{/if}