...
2/7/2013 6:07 PM Andy
- Fix total row.

3/5/2013 5:05 PM Andy
- Enhance to show latest group stock balance by when print picking list.
*}
{if !$skip_header}
...
<tr bgcolor=#cccccc>
	...
	<th nowrap width="40">Latest Group Stock Balance</th>
</tr>
...
{foreach from=$items item=r}
	...
	<tr class="no_border_bottom">
		...
		<td align="right">{$r.latest_group_stock_bal|qty_nf}</td>
	</tr>
