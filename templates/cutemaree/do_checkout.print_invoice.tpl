...
7/15/2011 1:18:49 PM Andy
- Add include 'header.print.tpl' for all printing templates, added support charset utf8.

8/9/2011 3:50:53 PM Andy
...
{if $is_lastpage}
	...
	<tr class="total_row">
		...
		{if $form.is_under_gst}
			{if $show_invoice}
				<th>{$form.inv_total_gross_amt|number_format:2}</th>
				<th>&nbsp;</th>
				<th>{$form.inv_total_gst_amt|number_format:2}</th>
			{else}
				<th>{$form.do_total_gross_amt|number_format:2}</th>
				<th>&nbsp;</th>
				<th>{$form.do_total_gst_amt|number_format:2}</th>
			{/if}
		{/if}
		{if $show_invoice}
