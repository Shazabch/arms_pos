		...
		<form name="f_a" class="noprint stdframe" method="post" onSubmit="return false;">
			...
			{if $BRANCH_CODE eq 'HQ'}
				<div>
					<div class="form-inline mb-2">
						...
						&nbsp;&nbsp;<input class="btn btn-success" type="button"  value="Select " onclick="MULTI_BRANCH_STOCK_BALANCE.check_branch_by_group(true);" />
						&nbsp;&nbsp;<input class="btn btn-danger" type="button"  value="De-select" onclick="MULTI_BRANCH_STOCK_BALANCE.check_branch_by_group(false);" />
					</div>
			...
			<p>
				...
				<div class="row">
					<div class="col-md-4">
						<span>
							<b class="form-label">Stock Filter: </b>
							<select class="form-control" name="stock_filter_type">
			...
			<p>
				<button class="btn btn-primary mt-2" onClick="MULTI_BRANCH_STOCK_BALANCE.submit_report();">{#SHOW_REPORT#}</button>
				{if $sessioninfo.privilege.EXPORT_EXCEL eq '1'}
					<button class="btn btn-info mt-2" onClick="MULTI_BRANCH_STOCK_BALANCE.submit_report('excel');">{#OUTPUT_EXCEL#}</button>
				{/if}
				<input class="btn btn-primary mt-2" type="button" onclick="MULTI_BRANCH_STOCK_BALANCE.do_print();" value="Print" />&nbsp;
			</p>
