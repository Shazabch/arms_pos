...
<form name="f_a" method="post" onSubmit="return false;" class="stdframe">
	...
	{if $BRANCH_CODE eq 'HQ'}
		&nbsp;<b>GRN Branch</b>
		<select name="branch_id" onChange="GRN_DISTRIBUTION_REPORT.change_branch();">
	...
	<table>
		<tr>
			<td><b>GRR Document No.</b></td>
			<td>
				<input type="text" name="doc_no" style="width:300px;" value="{$smarty.request.doc_no}" onFocus="this.select();" />
