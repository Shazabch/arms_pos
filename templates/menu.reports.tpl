...
<li><a href="#" class=submenu><img src="/ui/icons/table.png" align=absmiddle border=0> Sales Report</a>
	<ul>
		<li><a href="/report.actual_and_target_sales_by_week.php">{*hb06 -*} Actual and Target Sales by Day / Week</a></li>
		{if $BRANCH_CODE eq 'HQ'}
		<li><a href="/report.branches_sales_comparison_by_day.php">{*hq02 -*} Branches Sales Comparison by Day / Week</a></li>
		...
		{if file_exists("`$smarty.server.DOCUMENT_ROOT`/report.consignment_sales_by_sku.php")}<li><a href="report.consignment_sales_by_sku.php">Consignment Sales by SKU Report</a></li>{/if}
		...
		<li><a href="/report.daily_consignment_outright_sales_by_category.php">{*hb02  -*} Daily Consignment/Outright/Concessionaire Sales by Category</a></li>
		...
		<li><a href="/report.hourly_sales_by_category.php">{*hb09 -*} Hourly Sales by Category</a></li>
		<li><a href="/report.hourly_sales_by_day.php?view_type=day">{*hb10 -*} Hourly Sales by Day</a></li>
		<li><a href="/report.hourly_sales_by_day.php?view_type=month">{*hb11 -*} Hourly Sales by Month</a></li>
		<li><a href="/report.monthly_consignment_outright_sales.php">{*hb07 -*} Monthly Consignment/Outright/Concessionaire Sales </a></li>
		...
		{/if}
		<li><a href="/report.monthly_sales_comparison_by_category.php">{*hb01 -*} Monthly Sales Comparison by Category</a></li>
...
<li><a href="#" class=submenu><img src="/ui/icons/chart_curve.png" align=absmiddle border=0> Performance Report</a>
	<ul>
		...
		<li><a href="report.brand_sales_ranking_comparison_by_branch.php">{*ph02 -*} Brand Sales Ranking Comparison by Branch</a></li>
		{if $BRANCH_CODE eq 'HQ'}
		<li><a href="report.category_sales_ranking_comparison_by_branch.php">{*ph01 -*} Category Sales Ranking Comparison by Branch</a></li>
		{/if}
		...
		{/if}
		<li><a href="report.consignment_performance_report.php">{*pb05 -*} Consignment Performance Report</a></li>
		<li><a href="report.daily_pwp_sku_sales.php">{*pb07 -*} Daily PWP SKU Sales</a></li>
		<li><a href="report.daily_sku_items_sales.php">{*pb04 -*} Daily SKU Items Sales</a></li>
		<li><a href="report.hourly_sku_items_sales.php">{*phb06 -*} Hourly SKU Items Sales</a></li>
		<li><a href="report.hourly_sku_items_sales_by_race_and_category.php">{*pb08 -*} Hourly SKU Items Sales by Race and Category</a></li>
	    <li><a href="report.monthly_brand_sales_by_category.php">{*pb02 -*} Monthly Brand Sales by Category</a></li>
		<li><a href="report.monthly_sales_report_by_category.php">{*pb01 -*} Monthly SKU Items Sales Ranking by Category</a></li>
		<li><a href="report.monthly_vendor_sales_by_category.php">{*pb03 -*} Monthly Vendor Sales by Category</a></li>
		<li><a href="report.profit_and_loss_report_by_sku_items.php">{*pb09 -*} Profit and Loss Report by SKU Items</a></li>
		{if $BRANCH_CODE eq 'HQ'}
	    <li><a href="report.quaterly_branch_sales_by_sku_category.php">{*phb09 -*} Quarterly Branch Sales by Category / SKU Items</a></li>
		{/if}
		<li><a href="report.quaterly_sales_by_sku_category.php">{*phb01 -*} Quarterly Sales by Category / SKU Item</a></li> {* Disabled fpr pkt-hq *}
		...
		<li><a href="report.daily_sku_items_sales_by_second_last_category.php">{*phb03 -*} Sales by 4th Level Category</a></li>
	    {if $BRANCH_CODE eq 'HQ'}
	    <li><a href="report.sku_item_sales_of_brand_comparison_by_branch.php">{*ph03 -*} SKU Items Sales of Brand Comparison by Branch</a></li>
	    <li><a href="report.sku_item_sales_of_vendor_comparison_by_branch.php">{*ph04 -*} SKU Items Sales of Vendor Comparison by Branch</a></li>
	    {/if}
...
<li><a href="#" class=submenu><img src="/ui/icons/group.png" align=absmiddle border=0> Membership Report</a>
	<ul>
	<li><a href="/report.hourly_member_sales_comparison_by_month.php">{*mhb02 -*} Hourly Member Sales Comparison by Month / Day</a></li>
	<li><a href="/report.member_sales_comparison_by_day.php">{*mhb01 -*} Member Sales Comparison by Day</a></li>
	...
	<li><a href="/report.member_sales_ranking.php">{*mhb04 -*} Member Sales Ranking</a></li>
