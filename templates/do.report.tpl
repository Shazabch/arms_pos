...
<div class="card mx-3">
	<div class="card-body">
		<form name="f_a" class="noprint" method="post">
	
			<!-- popup div -->
			<div class="modal popup_div" id="div_from_b_details">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content modal-content-demo">
						<div class="modal-header bg-danger" id="div_from_b_details_header">
							<h6 class="modal-title text-white">Please Choose Delivery From</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true" class="text-white">&times;</span></button>
						</div>
						<div class="modal-body" id="div_from_b_details_content">
							<div style="background:white;padding: 10px; width:100p%;height:300px;border:1px inset gray	;overflow:auto;">
								<ul class="no_point">
									<li>
							...
							<p align="center">
								<input type="button" class="btn btn-primary mt-2" value="OK" onClick="default_curtain_clicked();"></p>
						</div>
			...
			<div class="modal" id="div_to_b_details">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content modal-content-demo">
						<div class="modal-header bg-danger" id="div_to_b_details_header">
							<h6 class="modal-title text-white ">Please Choose Delivery To</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true" class="text-white">&times;</span></button>
							<div style="clear:both;"></div>
						</div>
						<div class="modal-body" id="div_to_b_details_content">
							<div style="background:white;padding: 10px; width:100p%;height:300px;border:1px inset black;overflow:auto;">
								<ul class="no_point">
									<li>
							...
							<div class="alert alert-primary rounded mt-2 " style="max-width: 5	00px;">
								*Note: Delivery To Branch Will only effect on Transfer Type DO
							</div>
							
							<p align="center">
								<input type="button" class="btn btn-primary" value="OK" onClick="default_curtain_clicked();"></p>
						</div>
					</div>
				</div>
			</div>
