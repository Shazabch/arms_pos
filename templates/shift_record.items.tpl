...
<div class="card mx-3">
    <div class="card-body">
        <div class="table-responsive">
            <table id="tbl_sr"  class="report_table table mb-0 text-md-nowrap  table-hover border" >
                ...
                <thead class="bg-gray-100" style="height: 30px;" >
                 ...
                 <tbody id="div_sr" class="fs-08" style="height:200px;overflow:auto">
                 {/if}
                ...
                <p align=center class="mt-3">
                    ...
                    {/if}
                    {else}
                    <input type=button class="btn btn-danger" value="Close" onclick="document.location='/shift_record.php'">
                    {/if}
                    </p>
</div>
</div>
