...
<p>- Sales Target saved as MKT{$smarty.request.id|string_format:"%05d"}</p>
{elseif $smarty.request.t eq 'confirm'}
<p>- MKT{$smarty.request.id|string_format:"%05d"} has been submitted for approval.</p>
{/if}
...
function list_sel(n,s){
	...
	new Ajax.Updater('mkt_list', 'mkt2.php', {
...
<tr>
<th><h3>Branch :</h3></th>
<td><select name="branch_id" onchange="list_sel(1);">
...
<!--a href="javascript:list_sel(2)" id=lst2>Submitted</a-->
