...
7/15/2011 2:46:44 PM Andy
- Add include 'header.print.tpl' for all printing templates, added support charset utf8.

8/10/2011 3:10:30 PM Andy
...
<tr class="total_row xlarge">
	...
	<td align=right class="total_row">{$total_ctn|qty_nf}</td>
	<td align=right class="total_row">{$total_pcs|qty_nf}</td>
</tr>
