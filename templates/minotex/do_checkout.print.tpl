...
7/15/2011 2:42:04 PM Andy
- Add include 'header.print.tpl' for all printing templates, added support charset utf8.

8/10/2011 3:08:48 PM Andy
...
<tr class="no_border_bottom {if $smarty.section.i.iteration eq $PAGE_SIZE and !$is_lastpage}td_btm_got_line{/if}">
	...
	<td align="center" class="s2">{$do_items[i].sku_item_code}</td>
...
<tr class="total_row got_btm">
  	<th align=right colspan={if !$hide_RSP}6{else}5{/if} class="total_row  got_left got_right xlarge">Total</th>
