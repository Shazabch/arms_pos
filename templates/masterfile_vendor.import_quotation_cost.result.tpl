...
<p>
	...
	<input type="button" id="update_btn" name="update_btn" value="Update" onclick="IMPORT_QUOTATION_COST_MODULE.update_quotation_cost(1);" {if !$result.updated_row}disabled{/if} />
</p>
<div class="div_tbl">
