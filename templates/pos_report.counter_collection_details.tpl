...
{if $smarty.request.load_report and !$err}
	...
	{else}
		...
		<!-- Total -->
		<table class="report_table {if $is_print}tb{/if}" {if $is_print}border="0" cellspacing="0" cellpadding="4"{/if}>
			<tr class="header">
		...
		<table width="100%" class="report_table {if $is_print}tb{/if}" {if $is_print}border="0" cellspacing="0" cellpadding="4"{/if}>
		...
		{if $is_print}
			...
			{if $config.counter_collection_details_extra_print_area}
				...
				<br />
				<div class="printarea">
					<table class="tb tb2" border="0" cellspacing="0" cellpadding="4">
						<tr>
							<td colspan="3">&nbsp;</td>
							<th>Debit</th>
							<th>Credit</th>
