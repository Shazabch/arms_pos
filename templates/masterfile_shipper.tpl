...
function submit_form(action){
	if(action=='close'){
		...
		if(document.f_a['type'].value == 0){
			alert('Please select a Transporter Type.');
			return false;
		}
		...
		if(!document.f_a['contact_person'].value.trim()){
...
<div id="div_transporter_popup" class="curtain_popup" style="position:absolute;z-index:10000;width:500px;height:380px;display:none;border:2px solid #CE0000;background-color:#FFFFFF;background-image:url(/ui/ndiv.jpg);background-repeat:repeat-x;padding: 0 !important;">
	<div id="div_transporter_popup_header" style="border:2px ridge #CE0000;color:white;background-color:#CE0000;padding:2px;cursor:default;"><span style="float:left;">Transporter</span>
...
<div>
	<ul>
		<li>
			<img src=ui/new.png title="New" align=absmiddle border=0></a><a href="javascript:void(open(0))"> Add New Transporter</a>
		</li>
	</ul>
</div>
...
<div id="div_table" class="stdframe">
	{include file='masterfile_shipper.table.tpl'}
</div>
