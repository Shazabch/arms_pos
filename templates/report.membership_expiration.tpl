...
<p>
	...
	<b>Expire Date From</b> <input size="10" type="text" name="date_from" value="{$smarty.request.date_from}{$form.from}" id="date_from">
...
<p>
	<b>Transaction Count From</b>
	<input type="text" name="trans_count_from" value="{$smarty.request.trans_count_from}" size="5" />
	&nbsp;&nbsp;
	
	<b>To</b>
	<input type="text" name="trans_count_to" value="{$smarty.request.trans_count_to}" size="5" />
	&nbsp;&nbsp;&nbsp;&nbsp;
