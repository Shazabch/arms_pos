...
<p>
<select name="date_type"onchange="change_date(this)" id="date_type">
...
<h4>{$grr[i].branch}</h4>
{/if}
<table class="sortable" width="100%" cellspacing="1" cellpadding="4" border="0" style="border:1px solid #000;padding:1px;">
...
{/if}
<tr bgcolor='{cycle values="#eeeeee,#ffffff"}' id="tr_grr-{$grr[i].branch_id}-{$grr[i].id}" class="tr_grr">
