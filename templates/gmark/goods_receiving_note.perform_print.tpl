...
11/11/2010 4:19:08 PM Justin
- Add Prepared By, Check By, Approved By, Account By on the footer.
...
7/15/2011 1:34:27 PM Andy
- Add include 'header.print.tpl' for all printing templates, added support charset utf8.

7/21/2011 3:56:54 PM Justin
- Modified the SKU's description to show in full but not to truncate and show only 25 characters.
...
<tr height=30 bgcolor="{cycle name=r1 values=",#eeeeee"}" class="no_border_bottom">
	{if !$page_item_info.$iid.not_item}
		...
		<!--td>{$item.description|truncate:'25':'...'}</td-->
	{else}
		<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
	{/if}
	<td><div style="height:2em">{$item.description}</div></td>
	...
	{if !$page_item_info.$iid.not_item}
		...
		{assign var=t_cost value=$t_cost|round:2}
