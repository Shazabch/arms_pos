...
<h2 align="center">Third Level Category Sales Report</h2>
	<p>
		<input type="hidden" name=a value="" />
		{if $c_type =='gender'}
			<b>Gender :</b>
			<select id="table_gender">
		...
		<b>Date From :</b>
		<input size="10" type="text" value="{$smarty.request.table_date_from}" name="table_date_from" id="table_date_from" placeholder="yyyy-mm-dd" >
		&nbsp;
		<b>To</b> 
		<input size="10" type="text" value="{$smarty.request.table_date_to}" name="table_date_to"  id="table_date_to" placeholder="yyyy-mm-dd">
		&nbsp;&nbsp;
	...
	<b>Category :</b>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="button" value="Refresh" id="refresh_btn3" onclick="HOME.reload_table_report();">
	</p>	
	<br>	
