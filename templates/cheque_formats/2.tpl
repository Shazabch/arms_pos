<!--BANK ISLAM CHEQUE PRINTING TEMPLATE-->
...
#margin_offset {
	...
	margin-left:1.2cm;
	*/
	margin-top:{/literal}{$margin.top|default:5.6}cm{literal};	
	margin-left:{/literal}{$margin.left|default:11.5}cm{literal};
}
