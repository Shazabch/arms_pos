...
<button class="btn btn-primary" class="btn-primary" onClick="submit_form();">{#SHOW_REPORT#}</button>
{if $sessioninfo.privilege.EXPORT_EXCEL eq '1'}
<button class="btn btn-primary" class="btn-primary" onClick="submit_form('excel');">{#OUTPUT_EXCEL#}</button>
{/if}
</p>
</form>
