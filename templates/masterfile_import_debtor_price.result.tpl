...
<p>
	...
	<br/>
	<br/>
	<input type="button" class="btn btn-primary " id="update_btn" name="update_btn" value="Update" {if $BRANCH_CODE eq 'HQ'}disabled{/if} onclick="UPDATE_MODULE.import_debtor();"/>
</p>
</form>
<div class="div_tbl">
	<div class="card mx-3">
