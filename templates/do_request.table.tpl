...
<button class="btn btn-primary" onclick="list_sel('{$curr_tab}');">Refresh</button>

{if $highlight_sku_item_id}
	<br />
	<span style="color:blue;">* Display selected item only.</span>
{/if}
<table id="items_tbl" width="100%" cellpadding="4" cellspacing="1" border="0" style="padding:2px;margin-top: 10px">
<tr bgcolor=#ffee99>
	<th rowspan="2">
		{if count($items)>0 and $smarty.request.t eq 1}
