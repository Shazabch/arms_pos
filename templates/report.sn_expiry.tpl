...
<select name="warranty_expired_type">
    <option {if $smarty.request.warranty_expired_type eq '1'}selected {/if} value="1">More Than</option>
    <option {if $smarty.request.warranty_expired_type eq '2'}selected {/if} value="2">After</option>
    <option {if $smarty.request.warranty_expired_type eq '3'}selected {/if} value="3">Within</option>
</select>
<input type="text" name="warranty_days" class="r" onchange="this.value=round(this.value, 0);" size="5" value="{$smarty.request.warranty_days}" /> Days
&nbsp;&nbsp;&nbsp;&nbsp;
