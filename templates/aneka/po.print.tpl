...
<tr height=15 class="rw{cycle name=crow values=",2"} no_border_bottom">
	...
	{if !$page_item_info.$item_id.not_item}
		...
		{if $item.is_foc}
			<th rowspan=2 style="border-top:1px solid #000;border-bottom:1px solid #000">FOC</th>
		{else}
...
<tr height=15 class="rw{cycle name=crow2 values=',2'}">
	...
	{else}
		...
		{/if}
		<td style="border-bottom:0px;">&nbsp;</td>
		<td style="background:{$rowbg};border-bottom:0px;{if $gp<0}font-weight:bold;{/if}">&nbsp;</td>
	{/if}
</tr>
{/if}
{/foreach}
