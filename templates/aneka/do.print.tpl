...
<tr class="no_border_bottom {if $smarty.section.i.iteration eq $PAGE_SIZE and !$is_lastpage}td_btm_got_line{/if}">
	...
	<td align="center" nowrap>{if $do_items[i].artno <> ''}{$do_items[i].artno}{elseif $do_items[i].mcode <> ''}{$do_items[i].mcode|default:'&nbsp;'}{else}{$do_items[i].artno_mcode|default:'&nbsp;'}{/if}</td>
