...
- Remove name, ic no and lorry no wording if all are empty
...
7/15/2011 11:24:15 AM Andy
- Add include 'header.print.tpl' for all printing templates, added support charset utf8.

8/10/2011 3:00:29 PM Andy
...
{/if}
*}
    <th align=right colspan={if !$hide_RSP}6{else}5{/if} class="total_row">Total</th>
...
<tr height=50>
	...
	<td valign=top>
		{if $form.checkout_info.name or $form.checkout_info.nric or $form.checkout_info.lorry_no}
