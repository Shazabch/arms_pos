			...
			onComplete: function(msg){	
				...
				try{
					...
					if(ret['ok'] == 1 || ret['partial_ok'] == 1){ // success
						alert("Successfully Imported Debtor Data.");
						$('div_result').hide();
						if (ret['partial_ok'] == 1) {
							$('div_invalid_'+m).show();
							$('invalid_link_'+m).href = 'attachments/debtor_import/invalid_'+file;
						}
						return;
					}else{  // save failed
