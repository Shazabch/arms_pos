...
{if !$no_header_footer}
	...
	<p nowrap style="padding-left: 5px">
		...
		<b class="title">Receipt No : </b>
		<input type="text" name="receipt_num" value="{$form.receipt_num}"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="checkbox" id="time_filter" name="time_filter" onChange="TRAN_DETAILS_ITEM_LISTING.toggleTimeFilter();" {if $form.time_filter}checked{/if}/>
		<b class="title">Time from </b>
	...
	<p nowrap style="padding-left: 5px">
		...
		<b class="title" >Transaction Status : </b>
		...
		<b class="title">Transaction Type : </b>
	...
	{if $sessioninfo.privilege.EXPORT_EXCEL eq '1'}
		<button class="btn btn-primary" id="button_export" onClick="TRAN_DETAILS_ITEM_LISTING.submit_form('excel');"><img src="/ui/icons/page_excel.png" align="absmiddle"> Export</button>
	{/if}
	</div>
	<br/>
	<ul>
...
{if $data}
	...
	<br/>
	<h3>Final Summary by SKU Items</h3>
	<table class="report_table" width="100%">
		<thead>
			<tr class="header">
