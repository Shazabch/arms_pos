...
Branch: <select name=branch_id onChange="refresh2();">
...
{/if}
Status: <select name=status onChange="refresh2();">
...
&nbsp;&nbsp;
Select username: <select name=user_id onChange="refresh();document.f_u.search_username.value = '';" {if $eform_user}id="select_disabled"{/if}>
...
&nbsp;&nbsp;
<input class="btn btn-primary" name=submitbtn type=button value="Refresh" onclick="refresh()" />
<br />
<table>
<tr>
<td>Search Username : </td><td><input type="text" id="search_username" name="search_username" style="width:400px;" /></td>
</tr>
<tr>
<td>&nbsp;</td><td><div id="autocomplete_username" class="autocomplete" style="display:none;height:150px !important;width:400px !important;overflow:auto !important;z-index:100"></div></td>
</tr>
</table>
</p>
</div>
