	...
	<table id="sac_item_{$date_item_id}" class="sac_items" width="100%" {if $header_is_hidden}style="display:none;"{/if}>
		<tbody>
			<tr>
				<td colspan="2">
					<b>Date Start: </b>
					<input size="10" type="text" name="selected_date_from[{$date_item_id}]" id="selected_date_from_{$date_item_id}" value="{$date_from|date_format:'%Y-%m-%d'}" class="selected_date_list">
