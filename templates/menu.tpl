				...
				<div class="main-sidemenu">
					<div class="app-sidebar__user clearfix">
						<div class="dropdown user-pro-body">
							...
							<div class="user-info">
								<h4 class="font-weight-semibold mt-3 mb-0">{if !$sa_session}{$BRANCH_CODE}{/if}</h4>
								<span class="mb-0 text-muted">{if $sessioninfo}
								Logged in as 
								{if $smarty.session.admin_session}
									{$smarty.session.admin_session.u}</b> (now running as {$sessioninfo.u} | <a href="/login.php?logout_as=1"><u>Logout</u></a>)
								{else}
									{$sessioninfo.u}
								{/if}
							{elseif $vp_session}
