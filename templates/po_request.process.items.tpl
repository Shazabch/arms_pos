...
*}
<div id="price_history" style="display:none;position:absolute;width:350px;height:275px;background:#fff;border:1px solid #000;padding:5px;">

	<div id="price_history_list" style="width:350px;height:250px;overflow:auto;"></div>
...
<tbody id=tbody_{$vendor.id}>
<tr bgcolor=#ffffee>
	<td><input type=radio name=vendor_id value="{$vendor.id}" onclick="check_all('tbody_{$vendor.id}', this)"></td>
	<td align=center colspan=2 nowrap>
		<input type=button value="Create PO" onclick="if (confirm('Press OK to create PO from selected vendor and items.')) form.submit();">
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input type=button value="Reject Selected" onclick="multiple_reject_items({$vendor.branch_id});">
	</td>
