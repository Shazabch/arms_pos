...
<div class="card mx-3">
	<div class="card-body">
		<div class="table-responsive">
			<table width=100%  class=" input_no_border small body report_table table mb-0 text-md-nowrap  table-hover"
			>
				...
				<!--START TABLE ITEMS-->
				<tbody id="do_items" class="fs-08 text-center">
				...
				<tfoot class="text-center">
					<!-- total -->
					<tr bgcolor="#ffffff" class="normal fs-08" height="24" id="total" >
