...
- Enhanced do print hide "Ctn" and hide "UOM" and display "Master UOM" when config "do_checkout_alt_print_template" is using "kawanheng/do_checkout.print.tpl".
*}
...
<tr bgcolor=#cccccc class="top_line">
	...
	<th rowspan=1 nowrap width=80>Pcs</th>
...
*}
	...
	<th align=right class="total_row">{$custom_total_pcs|qty_nf}</th>
{*
{if !$config.do_print_hide_cost}
