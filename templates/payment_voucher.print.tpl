...
<tr valign=top>
	...
	<td align=right valign=top>
	    <table class="tb1 normal" style="" border=0 cellspacing=0 cellpadding=1 width="100%">
	    
	    <tr>
	    <th nowrap colspan=6 width=480>Cheque Payment Voucher (Internal Copy)</th>
	    </tr>
...
<table class="small">
<tr>
<th width=150 align=left>Prepared By</td><td width=60>&nbsp;</td>
<th align=left width=150>Approved By</td><td width=60>&nbsp;</td>
<th align=left width=150>Cheque Signed By</td><td width=60>&nbsp;</td>
<th align=left width=150>Received By</td><td width=1>&nbsp;</td>
</tr>
</table>
<table style="padding-top:25px" class="xsmall">
<tr>
<td align=left width=150 style="border-top:1px solid black">Name : {$form.user_name}</td>
<td width=50>&nbsp;</td>
<td align=left width=150>&nbsp;</td>
<td width=50>&nbsp;</td>
<td align=left width=150>&nbsp;</td>
<td width=50>&nbsp;</td>
<td align=left width=150 style="border-top:1px solid black">Name :</td>
</tr>
<tr>
<td align=left width=150>Date : {$smarty.now|date_format:$config.dat_format}</td>
<td width=50>&nbsp;</td>
<td align=left width=150>&nbsp;</td>
<td width=50>&nbsp;</td>
<td align=left width=150>&nbsp;</td>
<td width=50>&nbsp;</td>
<td align=left width=150>I/C No :</td>
</tr>
<tr>
<td align=left width=150>&nbsp;</td>
<td width=50>&nbsp;</td>
<td align=left width=150 style="border-top:1px solid black">&nbsp;</td>
<td width=50>&nbsp;</td>
<td align=left width=150 style="border-top:1px solid black">&nbsp;</td>
<td width=50>&nbsp;</td>
