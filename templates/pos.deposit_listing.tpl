...
<form name="f_a" class="stdframe" method="post">
	...
	<b>Deposit Issued Branch: &nbsp;</b>
	{if $BRANCH_CODE eq 'HQ'}
		<select name="deposit_branch_id">
	...
	<b>Status: &nbsp;</b>
	<select name="deposit_status" onChange="DEPOSIT_LISTING.deposit_status_changed();">
	...
	<b>Receipt: </b>
	<input type="text" name="filter_receipt" size="8" value="{$smarty.request.filter_receipt}" />
	...
	<span id="span_filter_issued_branch" style="{if $smarty.request.deposit_status ne 'used'}display:none;{/if}">
		<p>
			...
			<b>Filter Issued Branch [<a href="javascript:void(alert('- No: It will ignore Deposit Issued Branch.\n- Yes: It will filter Deposit Issued Branch.'));">?</a>]: </b>
			<select name="used_filter_deposit_branch">
	...
	<p>
		<b>
			<span id="span_date_label">
				<span id="span_date_label-rcv" style="{if $smarty.request.deposit_status and $smarty.request.deposit_status ne 'rcv'}display:none;{/if}">Received</span>
		...
		<input id="inp_date_from" name="date_from" value="{$smarty.request.date_from}" size="10" /> 
		<img align="absbottom" src="ui/calendar.gif" id="img_date_from" style="cursor: pointer;" title="Select Date" />
		to
		<input id="inp_date_to" name="date_to" value="{$smarty.request.date_to}" size="10" /> 
		<img align="absbottom" src="ui/calendar.gif" id="img_date_to" style="cursor: pointer;" title="Select Date" />
		&nbsp;&nbsp;&nbsp;&nbsp;

		<input type="button" value="Refresh" onClick="DEPOSIT_LISTING.submit_form();" />
	</p>
</form>
