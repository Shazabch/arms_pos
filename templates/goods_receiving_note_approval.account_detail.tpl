...
<br>
<div align=right><img src="ui/flag.png" align=absmiddle> <span class=hilite>Enter the correct INVOICE Quantity or Price if different from Received</span></div>

<div id=tblist>
{include file=goods_receiving_note.account_list.tpl}
</div>
