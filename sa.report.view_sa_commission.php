...
7/18/2017 16:16 Qiu Ying
- Bug fixed on when commission method is Flat, the amount is not shown
*/
...
class VIEW_SA_COMMISSION extends Module{
  function __construct($title, $template=''){
		...
		if ($template=='') $template = str_replace(".php", ".tpl", basename($_SERVER['PHP_SELF']));
