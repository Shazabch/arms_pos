				...
				<div class="main-sidemenu">
					<div class="app-sidebar__user clearfix">
						<div class="dropdown user-pro-body">
							...
							<div class="user-info">
								<h4 class="font-weight-semibold mt-3 mb-0"><?php if (! $this->_tpl_vars['sa_session']): ?><?php echo $this->_tpl_vars['BRANCH_CODE']; ?>
<?php endif; ?></h4>
								<span class="mb-0 text-muted"><?php if ($this->_tpl_vars['sessioninfo']): ?>
								Logged in as 
								<?php if ($_SESSION['admin_session']): ?>
									<?php echo $_SESSION['admin_session']['u']; ?>
</b> (now running as <?php echo $this->_tpl_vars['sessioninfo']['u']; ?>
 | <a href="/login.php?logout_as=1"><u>Logout</u></a>)
								<?php else: ?>
					...
					<ul class="side-menu">
						...
						<li class="slide">
							<a class="side-menu__item" href="/login.php?logout=1" onclick="return confirm('<?php echo $this->_tpl_vars['LANG']['CONFIRM_LOGOUT']; ?>
