<div class="row px-2">
    ...
    {else}
        <a href="goods_receiving_record.php?a=show_setting&find_grr={$smarty.request.find_grr}" class="btn btn-indigo btn-rounded btn-sm mr-1"><i class="fas fa-cog"></i> Change Setting</a>
    {/if}
