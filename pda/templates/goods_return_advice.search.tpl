...
<div class="breadcrumb-header justify-content-between mt-3 mb-2 ">
	<div class="my-auto">
		<div class="d-flex">
			<h4 class="content-title mb-0 my-auto ml-1">{$LNG.OPEN_BY_GRA_NO}</h4>
		</div>
	</div>
</div>
			...
			<div class="table-responsive">
				<table class="table table-hover mb-0 text-md-nowrap">
					...
					<tbody>
						...
						<tr>
							<td><a href="{$smarty.server.PHP_SELF}?a=change_gra&id={$gra.id}&branch_id={$gra.branch_id}" data-placement="right" data-toggle="tooltip" title="{$LNG.EDIT}"><i class="fas fa-pen"></i></a></td>
							<td>{$LNG.GRA}#{$gra.id}</td>
