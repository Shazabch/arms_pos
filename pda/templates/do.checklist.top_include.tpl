...
{else}
    <a href="do.php?a=view_checklist_items&id={$form.id}&branch_id={$form.branch_id}" class="btn btn-success btn-sm "><i class="fas fa-th-list"></i> {$LNG.VIEW_CHECKLIST_ITEMS_LIST}</a>
{/if}