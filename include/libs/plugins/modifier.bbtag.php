 ...
 * ------------------------------------------------------------
 */
function smarty_modifier_bbtag($message, $iimgpath = '.') {
  $preg = array(
          ...
          '/(?<!\\\\)\[img(?::\w+)? align=(left|right)\](.*?)\[\/img(?::\w+)?\]/si' => "<img src=\"\\2\" align=\"\\1\" class=\"bb-image\" />",

          // [file]
         '/(?<!\\\\)\[file(?::\w+)?=(.*?)?\](.*?)\[\/file(?::\w+)?\]/si'      => "<a href=\"$iimgpath/\\1\" class=\"bb-url\">\\2</a>",

          // [iimg]
          '/(?<!\\\\)\[iimg(?::\w+)?\](.*?)\[\/iimg(?::\w+)?\]/si'             => "<img src=\"$iimgpath/\\1\" alt=\"\\1\" class=\"bb-image\" />",
          '/(?<!\\\\)\[iimg(?::\w+)?=(.*?)x(.*?)\](.*?)\[\/iimg(?::\w+)?\]/si' => "<img width=\"\\1\" height=\"\\2\" src=\"$iimgpath/\\3\" alt=\"\\3\" class=\"bb-image\" />",
          '/(?<!\\\\)\[iimg(?::\w+)? align=(left|right)\](.*?)\[\/iimg(?::\w+)?\]/si' => "<img src=\"$iimgpath/\\2\" align=\"\\1\" class=\"bb-image\" />",
          // [quote]
          ...
          //http and email
          '/([>\s]+)(http:\/\/[^\s<]+)(\s*?:<br\s*\/?>)?/si' => "\\1<a href=\"\\2\">\\2</a>\\3",
          '/([>\s]+)([a-z0-9\_\.]+@[a-z0-9\_\.]+)(\s*?:<br\s*\/?>)?/si' => "\\1<a href=\"mailto:\\2\">\\2</a>\\3",
