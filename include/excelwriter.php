<?php
/*
7/29/2011 9:36:45 AM Yinsee
- add utf8 to charset

8/2/2017 5:12 PM Andy
- Remove xmlns:o and xmlns:x in GetHeader()
*/
	...
	Class ExcelWriter
	{
		...
		var $state="CLOSED";
		var $newRow=false;
		var $sheetname = "Report Generated by ARMS";
		/*
...
//				<table x:str border=0 cellpadding=0 cellspacing=0 style='border-collapse: collapse;table-layout:fixed;'>
		...
		* @Return : Void
		*/
		function writeCol($value,$colspan=1,$rowspan=1)
		{
			if($this->state!="OPENED")
			{
				$this->error="Error : Please open the file.";
			...
			fwrite($this->fp,"<td class=xl24 colspan=$colspan rowspan=$rowspan width=64 >$value</td>");
		}
	}
?>
