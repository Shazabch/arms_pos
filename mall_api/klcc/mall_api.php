...
9/25/2020 11:44 AM Andy
- Fixed to only upload after finalised.

9/28/2020 2:02 PM Andy
- Fixed to remove "Thousand Separator" in number figures.

10/12/2020 5:43 PM William
...
class KLCC{
	...
	var $date_to;
	var $regen = false;
	var $config_name = 'klcc_setting';
	var $mall_name = 'KLCC Mall';
	var $configuration = array();
	var $batch_table_name = "klcc_batch";
